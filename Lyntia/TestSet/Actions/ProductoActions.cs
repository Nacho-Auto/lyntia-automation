...
namespace Lyntia.TestSet.Actions
{
    public class ProductoActions
    {
        ...
        //Metodo en el que agregamos un producto a un servicio tipo cambio de capacidad, seleccionamos un producto heredado con campos obligatorios sin rellenar y se guarda. CRM-APR0008
        ...
        //Metodo en el que una vez agregado un producto heredado se cumplimentan los campos obligatorios, se guarda y se cierra CRM-APR0008
        ...
        public void Borrado_de_producto()
        {
